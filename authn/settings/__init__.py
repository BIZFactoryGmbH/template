...
SECRET_KEY = 'sefopsfdiopvi[vsd3490efjsdfjfa`DJIOdsfdgsg9ij'
...
OIDC_RP_IDP_SIGN_KEY = 's'#os.environ['OIDC_RP_CLIENT_ID']
OIDC_OP_JWKS_ENDPOINT = 'sss'#os.environ['OIDC_RP_CLIENT_SECRET']
